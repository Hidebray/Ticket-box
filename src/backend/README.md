...
DATABASE_URL="postgresql://user:pass@host:5432/ticketbox_db?schema=public&connection_limit=15"

# [BẮT BUỘC] Dành cho Background Worker - Giới hạn tối đa 10 kết nối
DATABASE_URL_WORKER="postgresql://user:pass@host:5432/ticketbox_db?schema=public&connection_limit=10"
```
